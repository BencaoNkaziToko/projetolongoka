...
router.post('/adm_editar_inst', admController.adm_editar_inst)
router.post('/adm_eliminar_inst', admController.adm_eliminar_inst)
router.post('/admSaveedit_Inst', admController.admSaveedit_Inst)

// ----> GESTAO DE CURSOS ✅
router.post('/adm_addcurso_inst', admController.adm_addcurso_inst)
...
router.post('/adm_editar_curso', admController.adm_editar_curso)
...
router.post('/adm_elim_livro', admController.adm_elim_livro)
router.post('/adm_add_livro', admController.adm_add_livro)
router.post('/adm_edit_livro', admController.adm_edit_livro)
